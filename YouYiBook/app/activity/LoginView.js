            ...
            <View style={styles.page}>
                ...
                <View style={{ width: width, alignItems: 'center', marginTop: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <CustomBtn textColor='white' textSize={14} btnTxt='快速注册' _BtnOnlcik={() => this.onClick('0')} bgColor='#1CA831' btnWidth={120} btnHeight={30} />
                        <CustomBtn textColor='white' textSize={14} btnTxt='登录' _BtnOnlcik={() => this.onClick('1')} bgColor='#E2320E' btnWidth={120} btnHeight={30} />
                    </View>
                </View>
            </View>
        )
